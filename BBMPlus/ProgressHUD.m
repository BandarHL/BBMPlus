...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	self.imageSuccess		= [UIImage imageNamed:@"/Library/Application Support/BBMPlus/BBMPlus.bundle/progresshud-success" inBundle:bundle compatibleWithTraitCollection:nil];
	self.imageError			= [UIImage imageNamed:@"/Library/Application Support/BBMPlus/BBMPlus.bundle/progresshud-error" inBundle:bundle compatibleWithTraitCollection:nil];
	//---------------------------------------------------------------------------------------------------------------------------------------------
